...
class TestSearch(BaseTest):
    ...
    @pytest.mark.parametrize("email_address,password",ExcelUtils.get_data_from_excel("ExcelFiles/FoodApp.xlsx","LoginTest"))
    ...
    def test_login_with_invalid_email_and_valid_password(self):
        ...
        expected_warning_message = "Invalid Email or Password....!!"
        assert login_page.retrieve_warning_message().__contains__(expected_warning_message)

    def test_login_with_valid_email_and_invalid_password(self):
        home_page = HomePage(self.driver)
        login_page = home_page.navigate_to_login_page()
        login_page.login_to_application("ro@gmail.com","1234567890")
        expected_warning_message = "Invalid Email or Password....!!"
    ...
    def test_login_without_entering_credentials(self):
        ...
        expected_warning_message = "**Password field is required**"
        assert login_page.retrieve_password_warning_message().__contains__(
            expected_warning_message)
